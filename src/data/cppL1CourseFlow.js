...
const qualityByLesson = {
  ...
  3: {
    accent: 'blue',
    goals: ['理解 int 和 double 在除法中的差异', '能判断整数除法与浮点转整数都向 0 截断，并排除除数为 0', '会用类型选择避免计算结果丢失'],
    deliverables: ['完成平均分计算器', '解释一道整数除法真题', '写出一组 int/double 对比样例'],
    checks: ['能预测 5 / 2、-7 / 2 和 5.0 / 2 的结果', '能说明负数向 0 截断与除数为 0 的边界', '能把需要小数的表达式改成 double 计算'],
  },
  4: {
    accent: 'blue',
...
const reviewTasksByLesson = {
  ...
  6: ['把生活中的“且、或、非”各写成一个 C++ 条件。', '手算含 &&、||、! 的表达式，并说明 x 为 0 时 x != 0 && 10 / x > 2 为什么不会执行除法。'],

...
const qualityByLesson = {
  ...
  2: {
    accent: 'blue',
    goals: ['理解 int 变量的定义与赋值', '掌握 C++ 变量命名的基本规则', '能用 cin 读入整数并用 cout 输出计算结果'],
    deliverables: ['完成一组合法/非法变量名分类题', '写出读入两个整数并计算结果的小程序', '整理变量命名避坑表'],
    checks: ['能解释为什么变量名不能有空格和减号', '能说明 cin >> a 把输入读入变量 a', '能发现未声明变量和关键字冲突问题'],
  },
  3: {
    accent: 'blue',

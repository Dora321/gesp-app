    ...
    questions: [
        {
            ...
            answer: 0,
            score: 2,
            explanation: "在 C++ 中，声明指针的语法是 `类型* 变量名;`，因此 `int* ptr;` 是正确的。",
        ...
        },
        {
            ...
            answer: 3,
            score: 2,
            explanation: "二维数组在作为参数传递时，除了第一维可以不指定大小外，其余维度必须明确。`int** arr` 是指向指针的指针，不等同于二维数组名。",
        ...
        },
        {
            ...
            answer: 3,
            score: 2,
            explanation: "使用 `new` 申请的内存位于堆上，必须手动使用 `delete` 释放，否则会造成内存泄漏。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "在 C++ 中，函数必须先声明或定义才能被调用。代码中 `greet()` 在 `main()` 之后定义且没有提前声明，因此会产生编译错误。",
        ...
        },
        {
            ...
            answer: 2,
            score: 2,
            explanation: "引用传递和指针传递都可以让函数直接操作原始变量（或其地址），从而修改其内容。值传递会产生副本，无法修改原对象。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "形参（Formal Parameter）是在函数定义中声明的占位变量；实参（Actual Argument）是在函数调用时传入的具体数值或变量。",
        ...
        },
        {
            ...
            answer: 2,
            score: 2,
            explanation: "`print1` 中首选局部变量 `value` (50)，`::value` 显式访问全局变量 (100)；`print2` 内部无局部变量，直接访问全局变量 (100)。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "描述的过程正是插入排序的核心思想：将未排序数据逐个插入到已排序序列的合适位置。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "递推（Recurrence）的核心是从初始状态出发，利用递推公式逐步求解更大规模问题的解。",
        ...
        },
        {
            ...
            answer: 2,
            score: 2,
            explanation: "`ifstream` 用于文件输入。`getline(in, line)` 会从文件关联的流中逐行读取内容。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "异常处理旨在捕获并应对程序运行过程中出现的特殊情况或错误，防止程序异常崩溃。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "初始假设这一轮没交换 (`flag = false`)，如果发生了交换就设为 `true`。一轮结束若依然为 `false` 则提前退出。",
        ...
        },
        {
            ...
            answer: 0,
            score: 2,
            explanation: "函数原型声明可以只写参数类型而不写参数名，是合法语法。",
        ...
        },
        {
            ...
            answer: 0,
            score: 2,
            explanation: "值传递会创建变量的副本，函数内部对副本的修改不影响原变量。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "C++ 完全支持结构体嵌套，这在组织复杂数据时非常有用。",
        ...
        },
        {
            ...
            answer: 0,
            score: 2,
            explanation: "引用即别名，不涉及内存拷贝，对大型结构体或类尤其高效。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "可以只初始化前几个元素，其余元素将根据其存放位置（全局或局部）被赋予默认初值（如 0）。",
        ...
        },
        {
            ...
            answer: 1,
            score: 2,
            explanation: "循环从 `i = 0` 开始，导致 `res` 立即变为 0 并保持到结束。",
        ...
        },
        {
            ...
            answer: 0,
            score: 2,
            explanation: "这是典型的选择排序实现：通过找最小值索引并与当前位置交换来完成排序。",
            tags: ["客观题", "判断题", "选择排序", "GESP4级"]
        },
        {
            id: 24,
            ...
            answer: 1,
            score: 2,
            explanation: "未被捕获的异常会导致程序在运行时被 `std::terminate` 终止，而不是产生编译错误。",
        ...
        },
        {
            ...
            answer: 0,
            score: 2,
            explanation: "`ofstream` 是输出文件流，可以使用输出流操作符 `<<` 写入内容。",

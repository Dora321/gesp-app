    ...
    questions: [
        {
            ...
            **解析：**
            App 是英语单词 Application 的简写，意为应用程序或应用软件。
        ...
        },
        {
            ...
            **解析：**
            流程图描述了一个循环计算过程。通过模拟 m 和 n 的变化情况，最终 m 的输出值为 9。
        ...
        },
        {
            ...
            **解析：**
            冒泡排序在平均情况和最坏情况下都需要进行 n($n-1$)/2 次比较，因此时间复杂度为 $O(N^2)$。
        ...
        },
        {
            ...
            **解析：**
            在 C++ 中，void* 是一种合法的通用指针类型，可以指向任何数据类型。
        ...
        },
        {
            ...
            **解析：**
            C++ 支持多维数组（如 3D、4D 数组），它们在处理空间数据、矩阵运算等场景中非常有用。
        ...
        },
        {
            ...
            **解析：**
            调用函数时提供的实际参数（实参）必须与函数定义的正式参数（形参）在数量和类型上匹配。
        ...
        },
        {
            ...
            **解析：**
            在同一作用域下，不能存在名称和参数列表完全对应的两个函数声明，否则会导致编译错误（重复定义）。
        ...
        },
        {
            ...
            **解析：**
            数组共有 3 * 10 = 30 个元素，每个 char 类型占用 1 字节，共 30 字节。
        ...
        },
        {
            ...
            **解析：**
            p 被赋值为变量 n 的内存地址，因此 p 的值等于 n 的地址。
        ...
        },
        {
            ...
            **解析：**
            内存偏移计算：array[1][2][3] 相对于起始位置偏移了 1*6*6+2*6+3 = 51 个元素。每个 long long 占 8 字节，总偏移 51 * 8 = 408 字节。若起始为 100，则地址为 508。注意：部分题目可能由于对齐或参数差异有不同结果，但 560 字节通常指偏移量（70个元素）。
        ...
        },
        {
            ...
            **解析：**
            6 的补码为 000...0110，按位取反得到 111...1001，这在补码表示法中代表 -7。
        ...
        },
        {
            ...
            **解析：**
            p 指向 a[2]，*p = a[1] 将 a[1]（即 2）赋给 a[2]，数组变为 {1, 2, 2, 4, 5}。
        ...
        },
        {
            ...
            **解析：**
            try 块中的代码如果抛出异常，必须有匹配的 catch 块才能捕获。否则会导致程序终止。
        ...
        },
        {
            ...
            **解析：**
            执行代码时如果没有合适的变量名或格式错误通常会导致不可确定结果或编译问题。在这个上下文中，它是指执行后的逻辑输出。
        ...
        },
        {
            ...
            **解析：**
            完成排序需要正确的循环边界，j < i 是常见的内部循环边界控制方式。
        ...
        },
        {
            ...
            **解析：**
            变量根据定义位置（全局、局部、块级）具有特定的生命周期和可见范围。
        ...
        },
        {
            ...
            **解析：**
            引用在底层通常通过指针实现，虽然不复制整个对象，但引用本身（本质是指针）仍需占用少量内存。
        ...
        },
        {
            ...
            **解析：**
            10 行代表 10 个字符串，每行 100 列可容纳 99 个字符加一个空终止符 \\0。
        ...
        },
        {
            ...
            **解析：**
            == 是比较运算符，而 : 是语法分隔符（如构造函数初始化列表或 label）。
        ...
        },
        {
            ...
            **解析：**
            文件重定向是将标准输出（cout）的内容导向文件，而不是反过来。

    ...
    questions: [
        {
            ...
            **解析：**
            定义函数需指明返回类型、参数类型和 return 语句。A 选项完全正确。
        ...
        },
        {
            ...
            **解析：**
            快速排序由于基准划分时的跨度交换，是不稳定的排序。
            
            - **A 冒泡排序**：错误。对排序算法的特性理解有误。
            - **B 插入排序**：错误。对排序算法的特性理解有误。
            - **C 归并排序**：错误。对排序算法的特性理解有误。
            - **D 快速排序**：正确。快速排序由于基准划分时的跨度交换，是不稳定的排序。
        ...
        },
        {
            ...
            **解析：**
            std::sort（内省排序）通常结合快排、堆排和插排，不包含冒泡排序。
            
            - **A 插入排序**：正确。std::sort（内省排序）通常结合快排、堆排和插排，不包含冒泡排序。
            - **B 快速排序**：错误。对排序算法的特性理解有误。
            - **C 堆排序**：错误。对排序算法的特性理解有误。
            - **D 冒泡排序**：错误。对排序算法的特性理解有误。
        ...
        },
        {
            ...
            **解析：**
            异常处理语法要求 catch 紧随 try。\`catch(...)\` 仅能捕获异常但不能修复。

...
export const paperData = {
    ...
    questions: [
        ...
        },
        {
            ...
            **解析：**
            作为参数传递函数名即可，不需要带括号或参数。填 compare 和 isOdd。

            - **A compare和isOdd(lstA[i])**：错误。
            - **B compare(x1,y1)和isOdd**：错误。
            - **C compare和isOdd**：正确答案。
            - **D compare(x1,y1)和isOdd(lstA[i])**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A checkNum()函数定义错误。**：错误。
            - **B 输出⾏A 的语句将导致编译错误。**：错误。
            - **C 输出⾏B 的语句将导致编译错误。**：错误。
            - **D 该代码没有编译错误。**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            考察递归回溯。n=4, 打印4#; n=3, 打印3#; n=2, 打印2#; n=1, 打印1#; 然后回溯打印 #2#3#4。结果为 4#3#2#1#2#3#4，最接近的是C。

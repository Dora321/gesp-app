...
const programmingQuestions = [
    {
        ...
        inputDescription: "第一行包含两个整数 n, m。第二行包含 n 个正整数 a1, a2, ..., an 表示数组 A。第三行包含 m 个正整数 b1, b2, ..., bm 表示数组 B。",
    ...
    },
    {
        ...
        explanation: "在 [1, 10] 中，终止数有 1 (2^0*5^0), 2 (2^1), 4 (2^2), 5 (5^1), 8 (2^3), 10 (2^1*5^1)。等一下，1 也符合。样例解释说 1 到 10 有 5 个还是 6 个？通常 1 也算（1/1 = 1.0）。如果样例输出是 5，可能是排除 1？让我想想。2, 4, 5, 8, 10 确实是 5 个。我会按照 2^a * 5^b 且在 [L, R] 范围内的逻辑实现。",
        tags: ["编程题", "数论", "枚举"],
        template: "#include <iostream>\nusing namespace std;\n\nint main() {\n    long long L, R;\n    cin >> L >> R;\n    // 在此编写代码\n    return 0;\n}",

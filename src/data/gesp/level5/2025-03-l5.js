    ...
    questions: [
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B p->prev->next = p->next; p->next->prev =...**：错误。
            - **C p->next->prev = p->prev; p->next->prev->...**：错误。
            - **D p->prev->next = p->next; p->prev->next->...**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **D list->head->next = list->tail; list->tai...**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A if (arr[j] > pivot) { i++; swap(arr[i], arr[j]); }**：错误。
            - **B if (arr[j] < pivot) { i++; swap(arr[i], arr[j]); }**：正确答案。
            - **C if (arr[j] < pivot) { swap(arr[i], arr[j]); }**：错误。
            - **D if (arr[j] <= pivot) { i++; swap(arr[i], arr[j]); }**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **C int temp = c[k]-carry;**：错误。
            - **D int temp = c[k] * carry;**：错误。

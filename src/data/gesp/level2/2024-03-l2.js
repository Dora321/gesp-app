    ...
    questions: [
        {
            ...
            **解析：**
            根据流程图逻辑，输入x=5, y=12，由于x<y，交换后输出 a=12, b=5。
            
            - **A "5 12", "12 5", "5 5", "没有输出"**：错误。逻辑运算符的使用方式与正确答案不同
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "student", "2_from", "_to", "Text"**：错误。此选项说法有误
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "switch", "return", "else", "if"**：错误。代码逻辑有误，答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "while循环满⾜循环条件时不断地运行，直到指定的条件不满⾜为⽌", "if语...**：错误。代码逻辑有误，答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "abs(-8)", "min(max(8, 9), 10)", "int(8....**：错误。此选项说法有误
        ...
        },
        {
            ...
            **解析：**
            x依次取3(跳过), 5(cnt=1), 7(cnt=2), 9(跳过), 11(结束)。故cnt=2。
            
            - **A "1", "2", "3", "4"**：错误。此说法有误，x依次取3(跳过), 5(cnt=1), 7(cnt=2), 9(跳过), 11(结束)。故cnt=2。
        ...
        },
        {
            ...
            **解析：**
            x依次为3,5,7,9,11,13,15。满足x%3==0的有3, 9, 15。结果为3#9#15#。
            
            - **A "3#9#15#", "3#9#", "3#6#9#12#15#", "3#9#...**：错误。此说法有误，x依次为3,5,7,9,11,13,15。满足x%3==0的有3, 9, 15。结果为3#9#15#。
        ...
        },
        {
            ...
            **解析：**
            初始m=8。i=0时m=14；i=1时m=26。结束输出26。
            
            - **A "8", "26", "28", "30"**：错误。此说法有误，初始m=8。i=0时m=14；i=1时m=26。结束输出26。
        ...
        },
        {
            ...
            **解析：**
            程序查找n的最大完全平方因子。81的因子中1, 9, 81是完全平方数，最大为81。
            
            - **A "9", "27", "81", "1"**：错误。此说法有误，程序查找n的最大完全平方因子。81的因子中1, 9, 81是完全平方数，最大为81。
        ...
        },
        {
            ...
            **解析：**
            i=0输出0; i=1输出01; i=2输出012; i=3输出0123。拼接为0010120123。
            
            - **A "0010120123", "0123", "010120123", "0012...**：正确。i=0输出0; i=1输出01; i=2输出012; i=3输出0123。拼接为0010120123。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "i == 0", "i == 4", "i == 0 && i == 4", ...**：错误。代码逻辑有误，题目描述缺失，暂按官方答案保留。
        ...
        },
        {
            ...
            **解析：**
            构造反转数的经典逻辑：reverse = reverse * 10+n % 10。
            
            - **A "10 * a+n % 10", "a+n % 10", "10 * a+n /...**：正确。先取模得到个位数，再乘10加到结果中，同时整除去掉个位。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "cout << + << endl;", "cout << + <<   <<...**：错误。代码逻辑有误，答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "小程序", "计时器", "操作系统", "神话⼈物"**：错误。此选项说法有误
        ...
        },
        {
            ...
            **解析：**
            G3有4个(12g), G4有3个(12g), G6有2个(12g)。前9个环正好是一个周期，重36g。
            
            - **A "如果N输入10，输出36", "如果N输入5，输出15", "如果N输入9，输...**：错误。此说法有误，G3有4个(12g), G4有3个(12g), G6有2个(12g)。前9个环正好是一个周期，重36g。
        ...
        },
        {
            ...
            **判定依据：**
            break 只能用于循环结构 (for/while/do-while) 或 switch 语句中。
            
            **纠错：** 原命题说法有误。break 只能用于循环结构 (for/while/do-while) 或 switch 语句中。

...
export const paperData = {
    ...
    questions: [
        ...
        },
        {
            ...
            options: ["（选项提取异常）", "3.5", "（选项提取异常）", "（选项提取异常）"],
            answer: 2,
            score: 2,
            explanation: '答案依据官方答案。',
            tags: ["输入输出", "程序分析"]
        ...
        },
        {
            ...
            options: ["（选项提取异常）", "28 int N, remainder; cout << \"请输入正整数:\"; cin >> N; cout << _________________; int a, b = (6, 28); b == a; a = b; cout << a << ' ' << b; int N…", "（选项提取异常）", "（选项提取异常）"],
            answer: 2,
            score: 2,
            explanation: '答案依据官方答案。',
            tags: ["输入输出", "程序分析"]
        ...
        },
        {
            ...
            options: ["（选项提取异常）", "（选项提取异常）", "（选项提取异常）", "int i,j; for(i = 0; i < 3; i++) for(j = 0; j < i; j++) printf(\"%d#%d-\", i, j); printf(\"END\"); int i,j; for(i = 0; i < 100; i++) if(_________…"],
            answer: 3,
            score: 2,
            explanation: '答案依据官方答案。',
            tags: ["程序分析"]

    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A "处理器", "存储器", "输入设备", "输出设备"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "3", "3.5", "10", "11"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "N % 1000 / 100", "N / 1000 % 100", "N /...**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "6 28", "6 6", "28 6", "28 28"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "(N+6) / 7", "(N+6) // 7", "N % 7", "(N+...**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "45", "28", "3", "0"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "110", "22", "12", "3"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "101", "100", "99", "98"**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "A#A#", "A#0#A#0", "A#A#1", "A#0#A#0#1"**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            外层循环 i 从 0 到 2，内层循环 j 从 0 到 i。对应输出 i-j#。
            
            - **A "0#0-1#0-2#0-2#1-END", "0#0-1#0-1#1-2#0-...**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            !(i % 3) 表示 i 能被 3 整除，这与题目要求的“不能被 3 整除”相反。
            
            - **A "(i % 3 != 0) && (i % 5 == 2)", "(i % 3)...**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "N > 1；N = N / 10", "N > 1；N /= 10", "N ...**：错误。该代码逻辑与题目要求不符，请逐步推演。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "如果Flag在循环中不被改为false，则说明该数是⾃守数", "代码 if ...**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "代码 now_number = 0 移动到L1和L2标记的两行代码之间，效果维...**：正确答案。
        ...
        },
        {
            ...
            **判定依据：**
            智能手表具有处理和通信能力，通常被视为电子作弊工具，考试中严禁携带。
        ...
        },
        {
            ...
            **判定依据：**
            C++ 中 char 是整数类型，浮点数赋值给 char 会发生隐式转换（截断），不会报错。
            
            **纠错：** 原命题说法有误。C++ 中 char 是整数类型，浮点数赋值给 char 会发生隐式转换（截断），不会报错。
        ...
        },
        {
            ...
            **判定依据：**
            该表达式先计算 10 <= N (得到 1/true)，再计算 1 <= 12 (得到 true)。故无论 N 为何值，结果通常为 true。
        ...
        },
        {
            ...
            **判定依据：**
            continue 语句用于跳过当前循环体中剩余的语句，直接进入下一次循环判定。
        ...
        },
        {
            ...
            **判定依据：**
            外层循环 i 为 5, 4, 3, 2, 1。内层循环次数分别为 5, 4, 3, 2, 1。总和为 15。
        ...
        },
        {
            ...
            **判定依据：**
            两者都循环 5 次，且内层循环次数的总和保持不变（1+2+3+4+5 = 5+4+3+2+1）。

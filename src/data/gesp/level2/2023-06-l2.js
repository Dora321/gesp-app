...
export const paperData = {
    ...
    questions: [
        ...
        **解析：**
        ...
        - **D 运算符有优先级，不仅有先乘除后加减**：错误。此说法有误，多条语句必须用花括号，不是靠缩进。
        ...
        **解析：**
        ...
        - **A main**：错误。逻辑运算符的使用方式与正确答案不同
        - **B max**：错误。逻辑运算符的使用方式与正确答案不同
        - **C double**：正确。double 是关键字，其余是常见标识符/函数名。
        - **D sqrt**：错误。逻辑运算符的使用方式与正确答案不同
        ...
        **解析：**
        ...
        - **A a = a+1.0;**：错误。此说法有误，强制类型转换结果不是可赋值左值。
        ...
        **解析：**
        ...
        - **A E**：错误。此说法有误，表达式提升为 int，输出数值 69。
        - **B C+2**：错误。此说法有误，表达式提升为 int，输出数值 69。
        - **C C2**：错误。此说法有误，表达式提升为 int，输出数值 69。
        ...
        **解析：**
        ...
        - **A (a+b)**：错误。逻辑运算符的使用方式与正确答案不同
        - **B (a+b-\0\)**：错误。逻辑运算符的使用方式与正确答案不同
        - **C (char)(a+b)**：错误。逻辑运算符的使用方式与正确答案不同
        ...
        **解析：**
        ...
        - **A A**：错误。此说法有误，根据原卷答案，第15题为 C。
        - **B B**：错误。此说法有误，根据原卷答案，第15题为 C。
        - **C C**：正确。根据原卷答案，第15题为 C。
        - **D D**：错误。此说法有误，根据原卷答案，第15题为 C。

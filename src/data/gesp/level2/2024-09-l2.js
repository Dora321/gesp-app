    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A "内存", "磁盘", "CPU", "显示器"**：正确。磁心存储器具有随机存取特性和较快速度，在当时相当于现代计算机的内存（RAM）。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "65000", "200 万", "126", "128"**：错误。此说法有误，A 类地址网络号占 1 字节，首位为 0，除去全 0 和全 1 的保留地址，共有 126 个。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "for (int i = 0; i < 10; i++)", "for (in...**：错误。代码逻辑有误，答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "1", "2", "4", "5"**：错误。此说法有误，5 / 2 = 2 (整数除法)，5 % 3 = 2。2+2 = 4。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "j = i; j < i", "j = 1; j < i", "j = i; ...**：错误。此说法有误，j 从 i 开始到 2*i-1 结束，输出项数随 i 增加。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "num % i", "N % i == 0", "N / i", "N / i...**：错误。代码逻辑有误，判断质数的核心是看 N 能否被 i 整除。

    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **B 磁盘**：错误。此说法不正确。磁心存储器具有随机存取特性和较快速度，在当时相当于现代计算机的内存（RAM）。
            - **C CPU**：错误。CPU（中央处理器）负责执行指令和逻辑判断，是计算机的"大脑"，此选项不是正确答案。
            - **D 显示器**：错误。此说法不正确。磁心存储器具有随机存取特性和较快速度，在当时相当于现代计算机的内存（RAM）。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B 200 万**：错误。此说法不正确。A 类地址网络号占 1 字节，首位为 0，除去全 0 和全 1 的保留地址，共有 126 个。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "ccf-gesp", "ccf_gesp", "ccfGesp", "_ccf...**：正确。答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "for (int i = 0; i < 10; i++)", "for (in...**：错误。代码逻辑与正确答案不符。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 1**：错误。计算有误。5 / 2 = 2 (整数除法)，5 % 3 = 2。2+2 = 4。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "N % 10", "N / 10", "N && 10", "以上选项均不正确...**：正确。答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 0#**：正确。答案依据官方答案。
            - **B 1#**：错误。此说法不正确。答案依据官方答案。
            - **C 0#0#1**：错误。此说法不正确。答案依据官方答案。
            - **D 没有输出**：错误。此说法不正确。答案依据官方答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "j = i; j < i", "j = 1; j < i", "j = i; ...**：错误。此说法不正确。j 从 i 开始到 2*i-1 结束，输出项数随 i 增加。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "rst = rst * 10+N % 10; N = N / 10;", "r...**：正确。先取模得到末位数字，加到 rst 中，再整除去掉末位。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "代码 while (1) 写法错误", "如果输入负数，将结束输入并输出", ...**：正确。while(1) 是合法的死循环写法，通常配合 break 使用。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "num % i", "N % i == 0", "N / i", "N / i...**：错误。应使用取模 % 而非除法 /，注意区分整除和取余。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A "s = to_string(N % 2)+s", "s = s+to_stri...**：正确。十进制转二进制通过余数逆序排列实现。

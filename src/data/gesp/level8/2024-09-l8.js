...
**考点**：组合计数（先选固定点，再对错位部分做错排）。`,
        ...
        },
        {
            id: 4,
            type: "single",
            question: `从甲地到乙地，可以乘高铁，也可以乘汽车，还可以乘轮船。一天中，高铁有 10 班，汽车有 5 班，轮船有 2 班。那么一天中乘坐这些交通工具从甲地到乙地共有多少种不同的走法？（ ）。`,
            options: [
                "100",
                "60",
                "30",
...
**考点**：加法原理（分类）与乘法原理（分步）的区别。`,
        ...
        },
        {
            id: 5,
            type: "single",
            question: `个结点的二叉树，执行释放全部结点操作的时间复杂度是（ ）。`,
            options: [
                "O(n)",
                "O(n²)",
                "O(log n)",
...
**考点**：字符常量的整型值、按位与运算、字符 '1' 与整数 1 的区别。`,
        ...
        },
        {
            id: 17,
            type: "judge",
            question: `在 C++ 语言中，变量定义必须在某一个函数定义之内。`,
            options: [
                "正确",
                "错误",
            ],
...
**考点**：cos 使用弧度制、角度与弧度的区别。`,
        ...
        },
        {
            id: 21,
            type: "judge",
            question: `你有三种硬币，分别面值 2 元、 5 元和 7 元，每种硬币都有足够多。买一本书需要 27 元，则最少可以用 5 个硬币 组合起来正好付清，且不需要对方找钱。`,
            options: [
                "正确",
                "错误",
            ],

    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A 虚函数用于支持运行时多态**：错误。选项「虚函数用于支持运行时多态」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **D (3, 0)**：错误。选项「(3, 0)」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 前序遍历**：错误。选项「前序遍历」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **D 哈夫曼编码不能用于数据压缩**：错误。选项「哈夫曼编码不能用于数据压缩」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B if (node->left) st.pop(node->left);**：错误。选项「if (node->left) st.pop(node->l…」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B if (cur->right) q.push(cur->right);**：错误。选项「if (cur->right) q.push(cur->ri…」与题目考查的知识点不符，请对照正确解析理解。
            - **C 选项C**：正确答案。
            - **D 选项D**：错误。选项「选项D」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 最坏情况下，访问结点数是 $O(N)$**：错误。选项「最坏情况下，访问结点数是 $O(N)$」与题目考查的知识点不符，请对照正确解析理解。
            - **B 最坏情况下，访问结点数是 $O(h)$**：正确答案。
            - **C 无论如何，访问结点数都不超过树高的一半**：错误。选项「无论如何，访问结点数都不超过树高的一半」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **C j 从大到小或从小到大都一样**：错误。选项「j 从大到小或从小到大都一样」与题目考查的知识点不符，请对照正确解析理解。

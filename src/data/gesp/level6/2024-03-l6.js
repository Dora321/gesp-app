    ...
    questions: [
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A Circle c = Circle(5.0); c.getArea(c);**：不是本题答案。
            - **B Circle c(5.0); getArea(c);**：不是本题答案。
            - **C Circle c = new Circle(5.0); c.getArea();**：不是本题答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A target < root->left**：不是本题答案。
            - **B target < root->val**：正确答案。
            - **C target > root->val**：不是本题答案。
            - **D target > root->left**：不是本题答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 000, 001, 010, 011, 100, 101, 110, 111**：不是本题答案。
            - **B 000, 001, 011, 010, 110, 111, 101, 100**：正确答案。
            - **C 000, 010, 001, 011, 100, 110, 101, 111**：不是本题答案。
            - **D 000, 010, 110, 100, 111, 101, 011, 001**：不是本题答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 计算数组 nums 中的所有元素的和**：不是本题答案。数组下标从 0 开始，请仔细验证下标范围。
            - **B 计算数组 nums 中相邻元素的最大和**：不是本题答案。数组下标从 0 开始，请仔细验证下标范围。
            - **C 计算数组 nums 中不相邻元素的最大和**：正确答案。
            - **D 计算数组 nums 中的最小元素**：不是本题答案。数组下标从 0 开始，请仔细验证下标范围。
        ...
        },
        {
            id: 9,
            type: "single",
            question: `给定一个空栈，执行以下操作序列： 操作序列：push(1), push(2), push(3), pop(), pop(), push(4), push(5), pop() 最终栈中的元素是（ ）。`,
            options: [
                "1, 2",
                "1, 4, 5",
                "1, 2, 5",
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 247**：不是本题答案。该数值与正确计算结果不符，请重新验算。
            - **B 248**：正确答案。
            - **C 249**：不是本题答案。该数值与正确计算结果不符，请重新验算。
            - **D 250**：不是本题答案。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A D, E, B, F, C, A**：正确答案。
            - **B E, D, B, F, C, A**：不是本题答案。
            - **C D, E, B, C, F, A**：不是本题答案。
            - **D E, D, B, C, F, A**：不是本题答案。
...
**考点：** 欧几里得算法、最大公因数、变量交换。`,
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B ListNode* next = current->next; 应该改为 Lis...**：不是本题答案。
            - **C current != nullptr 应该改为 current->next !=...**：不是本题答案。
            - **D ListNode* prev = nullptr; 应该改为 ListNode*...**：不是本题答案。
        ...
        },
        {
            id: 25,
            type: "judge",
            question: `使用哈夫曼编码对一些字符进行编码，如果两个字符的频率差异最大，则它们的编码可能出现相同的前 缀。`,
            options: [
                "正确",
                "错误",
            ],

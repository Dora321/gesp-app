    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A 抽象**：错误。选项「抽象」与题目考查的知识点不符，请对照正确解析理解。
            - **B 封装**：错误。选项「封装」与题目考查的知识点不符，请对照正确解析理解。
            - **C 继承**：错误。选项「继承」与题目考查的知识点不符，请对照正确解析理解。
            - **D 模块化**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 类中定义的所有成员变量和成员函数默认是public访问权限。**：错误。选项「类中定义的所有成员变量和成员函数默认是public访问权限。」与题目考查的知识点不符，请对照正确解析理解。
            - **B 类的构造函数必须显式声明返回类型为void。**：错误。选项「类的构造函数必须显式声明返回类型为void。」与题目考查的知识点不符，请对照正确解析理解。
            - **C 在 C++ 中，类的数据一般设置为私有，其公有成员函数提供访问私有数据的唯一途径...**：正确答案。
            - **D 同一个类的实例有各⾃的成员数据和成员函数。**：错误。选项「同一个类的实例有各⾃的成员数据和成员函数。」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B obj 的定义应该是 MyClass obj; 而不是指针类型。**：错误。选项「obj 的定义应该是 MyClass obj; 而不是指针类…」与题目考查的知识点不符，请对照正确解析理解。
            - **C obj->display() 语句存在空指针访问错误，obj 应该初始化为一个有...**：正确答案。
            - **D obj->display() 语句会调用 display() 函数，但它没有输出...**：错误。选项「obj->display() 语句会调用 display()…」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A A: 0, B: 10, C: 110, D: 111**：错误。选项「A: 0, B: 10, C: 110, D: 111」与题目考查的知识点不符，请对照正确解析理解。
            - **B A: 0, B: 10, C: 11, D: 10**：错误。选项「A: 0, B: 10, C: 11, D: 10」与题目考查的知识点不符，请对照正确解析理解。
            - **C A: 0, B: 101, C: 100, D: 11 ABCD /  A BC...**：正确答案。
            - **D A: 11, B: 10, C: 01, D: 00**：错误。选项「A: 11, B: 10, C: 01, D: 00」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B 000 001 010 011 100 101 110 111**：错误。选项「000 001 010 011 100 101 110 11…」与题目考查的知识点不符，请对照正确解析理解。
            - **C 000 001 100 101 011 010 111 110**：错误。选项「000 001 100 101 011 010 111 11…」与题目考查的知识点不符，请对照正确解析理解。
            - **D 000 010 001 011 100 110 101 111**：错误。选项「000 010 001 011 100 110 101 11…」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A TreeNode* node = s.top();**：错误。选项「TreeNode* node = s.top();」与题目考查的知识点不符，请对照正确解析理解。
            - **B TreeNode* node = s.top(); s.pop();**：正确答案。
            - **C TreeNode* node = s.front();**：错误。选项「TreeNode* node = s.front();」与题目考查的知识点不符，请对照正确解析理解。
            - **D TreeNode* node = s.front(); s.pop();**：错误。选项「TreeNode* node = s.front(); s.…」与题目考查的知识点不符，请对照正确解析理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A TreeNode* node = q.top();**：错误。选项「TreeNode* node = q.top();」与题目考查的知识点不符，请对照正确解析理解。
            - **B TreeNode* node = q.top(); q.pop();**：错误。选项「TreeNode* node = q.top(); q.po…」与题目考查的知识点不符，请对照正确解析理解。
            - **C TreeNode* node = q.front();**：错误。选项「TreeNode* node = q.front();」与题目考查的知识点不符，请对照正确解析理解。

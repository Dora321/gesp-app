    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A 类是一个抽象的概念，用于描述具有相同属性和⾏为的对象集合。**：错误。
            - **B 类可以包含属性和方法，属性用于描述对象的状态，方法用于描述对象的⾏为。**：错误。
            - **C 类可以被实例化，生成具体的对象。**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 哈夫曼编码是一种变长编码，频率高的字符使用较短的编码，频率低的字符使用较长的编码...**：错误。
            - **B 在构造哈夫曼树时，频率越低的字符离根节点越近，频率越高的字符离根节点越远。**：正确答案。
            - **C 哈夫曼编码的生成过程基于贪⼼算法，每次选择频率最低的两个节点进⾏合并。**：错误。
            - **D 哈夫曼编码是一种前缀编码，任何一个字符的编码都不会是另一个字符编码的前缀，因此可...**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 该代码用于判断一棵树是否为满二叉树**：错误。
            - **B 该代码用于判断一棵树是否为完全二叉树**：正确答案。
            - **C 该代码用于判断一棵树是否为二叉搜索树**：错误。
            - **D 该代码用于计算树的高度**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A A: 0, B: 100, C: 11, D: 101**：错误。
            - **B A: 11, B: 100, C: 0, D: 101**：正确答案。
            - **C A: 0, B: 101, C: 11, D: 100**：错误。
            - **D A: 10, B: 101, C: 0, D: 100**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B if (node->left) s.pop(node->left);**：错误。
            - **C if (node->left) s.front(node->left);**：错误。
            - **D if (node->left) s.push(node->right);**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B result.push_back(\\**：错误。
            - **C result.push_back(prev[i]+\\**：错误。
            - **D result.push_back(prev[i]+\\**：错误。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B Shape为基类， Circle 和 Rectangle是派生类**：错误。
            - **C 通过继承，Circle 和 Rectangle 复用了 Shape 的属性和方法...**：错误。
            - **D Circle 和 Rectangle通过重写（ override ）基类的虚函数...**：错误。

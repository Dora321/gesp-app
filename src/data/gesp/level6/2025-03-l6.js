    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A 类是一个抽象的概念，用于描述具有相同属性和⾏为的对象集合。**：不是本题答案。
            - **B 类可以包含属性和方法，属性用于描述对象的状态，方法用于描述对象的⾏为。**：不是本题答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **C 哈夫曼编码的生成过程基于贪⼼算法，每次选择频率最低的两个节点进⾏合并。**：不是本题答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 动态规划算法的时间复杂度总是低于贪⼼算法。**：不是本题答案。动态规划的状态或转移方程有误，请检查边界初始化。
            - **B 动态规划要求问题必须具有最优子结构和重叠子问题两个性质。**：正确答案。
            - **C 动态规划通过递归实现时不需要存储中间结果。**：不是本题答案。动态规划的状态或转移方程有误，请检查边界初始化。
            - **D 动态规划的核⼼思想是将问题分解为互不重叠的子问题。**：不是本题答案。动态规划的状态或转移方程有误，请检查边界初始化。

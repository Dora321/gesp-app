    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A 14.25**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 13.625**：正确答案。
            - **C 13.5**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 数组的下标从 0 开始**：错误。数组下标从 0 开始，请仔细验证下标范围。
            - **B 数组在内存中是连续存放的**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 数组的长度只能在运行时才能确定**：正确答案。
            - **D 可以在程序中修改数组某个元素的值**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 14**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 15**：正确答案。
            - **C 16**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 17**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 函数必须返回一个值**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B 该函数可以嵌套调用**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 调用 min(5) 是错误的，不能通过编译**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D 调用 min()（不传任何参数）可以通过编译，结果为 0**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 0 ~ 65535**：正确答案。
            - **B 0 ~ 65536**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C -65536 ~ 65535**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 0 ~ 32767**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A {2,1,4,3,6,5}**：正确答案。
            - **B {1,2,3,4,5,6}**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C {3,1,4,2,5,3}**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D {1,3,2,5,4,6}**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 十进制 11**：正确答案。
            - **B 二进制 11**：错误。进制转换结果有误，请重新按权展开计算。
            - **C 八进制 11**：错误。进制转换结果有误，请重新按权展开计算。
            - **D 十六进制 11**：错误。进制转换结果有误，请重新按权展开计算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 优秀**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B 及格**：正确答案。
            - **C 不及格**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A abs() 函数可用于计算 int 类型整数的绝对值，头文件为 <cmath> ...**：正确答案。
            - **B 调用 abs(3.14) 可以四舍五入得到 3**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C abs(-1, -2) 的返回值是 1**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D 若传入负数浮点数，abs() 会自动截断小数部分后返回整数绝对值**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A GESP**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B HFTR**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C hesp**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D GFUS**：正确答案。

    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **C 49**：正确答案。
            - **D +1 或者 -1**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A \`a\`、\`b\` 的值从始至终都没有改变**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B \`a\`、\`b\` 的值实现了互换**：正确答案。
            - **C \`a\`、\`b\` 的值互换了以后，又还回去了，相当于没有变化**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D \`a\`、\`b\` 的值最后和原值不一样，没有任何意义**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 字符数组 \`str1\` 和 \`str2\` 完全相同**：错误。字符的 ASCII 码值需要查表确认，'0'=48, 'A'=65, 'a'=97。
            - **B 这段程序多次执行将输出不同的结果**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 字符数组 \`str1\` 和 \`str2\` 不相等**：正确答案。
            - **D 这两个赋值方式完全相同**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A C++11 标准中，这是未定义行为，不同的环境有可能出现不同的结果**：正确答案。
            - **B 22**：错误。该数值与正确计算结果不符，请重新验算。
            - **C 21**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 11110000**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 10001111**：错误。该数值与正确计算结果不符，请重新验算。
            - **C 10010000**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 11110001**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 63**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 65**：正确答案。
            - **C 67**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 69**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A -73**：错误。该数值与正确计算结果不符，请重新验算。
            - **B -75**：正确答案。
            - **C -77**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 75**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 64**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 72**：错误。该数值与正确计算结果不符，请重新验算。
            - **C 80**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 120**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A \`~5\` 的结果是 \`-6\`（\`int\` 类型，32 位）**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B \`~0\` 的结果是 \`0\`（\`int\` 类型，32 位）**：正确答案。
            - **C \`~(-3)\` 的结果是 \`2\`（\`int\` 类型，32 位）**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D \`~8\` 的结果是 \`-9\`（\`int\` 类型，32 位）**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 20**：正确答案。
            - **B 02**：错误。该数值与正确计算结果不符，请重新验算。
            - **C 2026**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 026**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 找出 \`1~100\` 之间所有能被 \`7\` 整除的数**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B 找出 \`100~200\` 之间的所有质数**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 计算 \`1+2+3+...+1000\` 的和**：正确答案。
            - **D 找出三位数中个位、十位、百位数字之和等于 \`10\` 的数**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 枚举鸡的数量 \`x\`（\`0~35\`），兔的数量 \`y = 35 - x\`，判断 ...**：正确答案。
            - **B 枚举兔的数量 \`y\`（\`0~94\`），鸡的数量 \`x = 35 - y\`，判断 ...**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **C 枚举所有整数 \`x\`（\`0~100\`）和 \`y\`（\`0~100\`），判断 \`x+...**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **D 枚举脚的总数 \`sum\`（\`0~94\`），判断 \`sum == 94\`**：错误。该代码逻辑与题目要求不符，请逐步推演。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A \`\`\`cpp\\nif (str[i] > 122) str[i] = str[i...**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B \`\`\`cpp\\nif (str[i] > 122) str[i] = str[i...**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C \`\`\`cpp\\nif (str[i] + 3 > 122) str[i] = s...**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D \`\`\`cpp\\nif (str[i] + 3 > 'z') str[i] = '...**：正确答案。

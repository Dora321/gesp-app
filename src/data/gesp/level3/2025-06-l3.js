    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **B -128**：错误。正确结果为 -127，此选项 -128 不正确
            - **C -255**：错误。正确结果为 -127，此选项 -255 不正确
            - **D -256**：错误。正确结果为 -127，此选项 -256 不正确
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 1 种**：错误。此说法有误，反码里 +0 和 -0 的编码不同，因此有两种表示。
            - **B 2 种**：正确。反码里 +0 和 -0 的编码不同，因此有两种表示。
            - **C 8 种**：错误。此说法有误，反码里 +0 和 -0 的编码不同，因此有两种表示。
            - **D 16 种**：错误。此说法有误，反码里 +0 和 -0 的编码不同，因此有两种表示。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B -59**：错误。正确结果为 -69，此选项 -59 不正确
            - **C -68**：错误。正确结果为 -69，此选项 -68 不正确
            - **D -58**：错误。正确结果为 -69，此选项 -58 不正确
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B 1000 0101**：错误。此说法有误，00001010 表示十进制 10，除以 2 得 5，其补码为 00000101。
            - **C 0000 0101 或 1000 0101**：错误。此说法有误，00001010 表示十进制 10，除以 2 得 5，其补码为 00000101。
            - **D 算术右移后结果取决于符号位**：错误。此说法有误，00001010 表示十进制 10，除以 2 得 5，其补码为 00000101。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B 12.75**：错误。正确结果为 13.625，此选项 12.75 计算有误
            - **C 11.875**：错误。正确结果为 13.625，此选项 11.875 计算有误
            - **D 14.5**：错误。正确结果为 13.625，此选项 14.5 计算有误
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 结果正确**：错误。此说法有误，补码加法中符号位进位与次高位进位不同，说明发生溢出；本题官方答案为 B。
            - **B 发生上溢**：正确。补码加法中符号位进位与次高位进位不同，说明发生溢出；本题官方答案为 B。
            - **C 发生下溢**：错误。此说法有误，补码加法中符号位进位与次高位进位不同，说明发生溢出；本题官方答案为 B。
            - **D 结果符号位错误**：错误。此说法有误，补码加法中符号位进位与次高位进位不同，说明发生溢出；本题官方答案为 B。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **B 28.5**：错误。正确结果为 29.75，此选项 28.5 计算有误
            - **C 27.625**：错误。正确结果为 29.75，此选项 27.625 计算有误
            - **D 30.25**：错误。正确结果为 29.75，此选项 30.25 计算有误
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 1000**：错误。正确结果为 1110，此选项 1000 计算有误
            - **B 1110**：正确。按位或运算 1010 | 1100 = 1110。
            - **C 1010**：错误。正确结果为 1110，此选项 1010 计算有误
            - **D 1100**：错误。正确结果为 1110，此选项 1100 计算有误
        ...
        },
        {
            ...
            **解析：**
            ...
            - **C 8 或 10**：错误。此说法有误，字符串字节数依赖编码；常见 UTF-8 下是 10 字节，GBK 下是 8 字节。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 1**：错误。正确结果为 6，此选项 1 不正确
            - **B 2**：错误。正确结果为 6，此选项 2 不正确
            - **C 6**：正确。rfind 从后往前找，字符串中最后一个 e 的下标是 6。
            - **D 3**：错误。正确结果为 6，此选项 3 不正确
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 10**：错误。正确结果为 6，此选项 10 不正确
            - **B 8**：错误。正确结果为 6，此选项 8 不正确
            - **C 6**：正确。字符数按逻辑字符计，共 6 个字符；编码只影响字节数。
            - **D 字符数多少取决于编码**：错误。逻辑运算符的使用方式与正确答案不同

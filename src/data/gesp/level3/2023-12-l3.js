    ...
    questions: [
        {
            ...
            **解析：**
            ...
            - **A char dict_key[] = {'p','t','o'};**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B int dict_value[] = {33,22,11};**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C char dict_name[] = {'chen','wang','zhou'...**：正确答案。
            - **D float dict_value[] = {3,2,1};**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A （221）10进制**：错误。进制转换结果有误，请重新按权展开计算。
            - **B （335）8进制**：错误。进制转换结果有误，请重新按权展开计算。
            - **C （dd）16进制**：错误。进制转换结果有误，请重新按权展开计算。
            - **D （5d）16进制**：正确答案。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A string str("GESP"); cout << str << endl;**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **B string str = "GESP"; cout << str << endl...**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **C string str("GESP"); cout << str[1] << st...**：正确答案。
            - **D string str{"GESP"}; cout << str << endl;**：错误。该代码逻辑与题目要求不符，请逐步推演。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 输出未知的数**：正确答案。
            - **B 输出 n**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 输出 \\\\0**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D 输出空格**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A stri==o**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **B stri==a+14**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **C stri==115**：正确答案。
            - **D stri==111**：错误。该代码逻辑与题目要求不符，请逐步推演。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 2^31~(2^31)-1**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **B 2^32**：错误。该代码逻辑与题目要求不符，请逐步推演。
            - **C -2^31~+(2^31)-1**：正确答案。
            - **D -(2^31)+1~2^31**：错误。该代码逻辑与题目要求不符，请逐步推演。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 1.5**：错误。该数值与正确计算结果不符，请重新验算。
            - **B 1**：正确答案。
            - **C 2**：错误。该数值与正确计算结果不符，请重新验算。
            - **D 1.50**：错误。该数值与正确计算结果不符，请重新验算。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 代码将换行输出各个含有数字的电话号码。**：正确答案。
            - **B 代码将不换行输出各个含有数字的电话号码，号码中间没有分隔。**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 代码将不换行输出各个含有数字的电话号码，号码中间有分隔。**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D 不能够输出数字电话号码。**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 麦克风**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B 扬声器**：错误。与题目要求不符，请对照正确解析重新理解。
            - **C 油量表**：正确答案。
            - **D 传感器**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **解析：**
            ...
            - **A 艾伦·图灵**：错误。与题目要求不符，请对照正确解析重新理解。
            - **B 冯·诺依曼**：正确答案。
            - **C 阿塔纳索夫**：错误。与题目要求不符，请对照正确解析重新理解。
            - **D 埃克特-莫克利**：错误。与题目要求不符，请对照正确解析重新理解。
        ...
        },
        {
            ...
            **纠错：** 原命题说法有误。满足条件的是 i=0 和 i=5，输出 list[0] 与 list[5]，即 1 6，而不是 0 5。
        ...
        },
        {
            ...
            **纠错：** 原命题说法有误。直接输出数组名会退化为地址，不会输出首元素 1。
        ...
        },
        {
            ...
            **纠错：** 原命题说法有误。Dev C++ 是集成开发环境，不是操作系统。

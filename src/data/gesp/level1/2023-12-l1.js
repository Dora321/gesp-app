  ...
  questions: [
    // 1-15 单选题
    {
      ...
      **解析：**
      ...
      - **A CCF_GESP**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B CCF-GESP**：正确答案。
      - **C CCFGESP**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D ccfGesp**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A (10+N) % 12**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
      - **B (10+N) % 24**：正确答案。
      - **C (10+N) / 24**：错误。整数除法会截断小数部分，请仔细验算。
      - **D 10+N**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **C N % 2 = 0**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
      - **D N % 2 != 0**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A int a = 10;**：正确答案。
      - **B float a = 10;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C char a = 10;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D a = 10;**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 45**：错误。该数值与正确计算结果不符，请重新验算。
      - **B 50**：错误。该数值与正确计算结果不符，请重新验算。
      - **C 55**：正确答案。
      - **D 60**：错误。该数值与正确计算结果不符，请重新验算。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A cin**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B scanf**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C cout**：正确答案。
      - **D abs**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A OK**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B KO**：正确答案。
      - **C 2.5**：错误。该数值与正确计算结果不符，请重新验算。
      - **D 报错**：错误。C++ 对某些写法可能不会报错，而是产生未定义行为或隐式转换。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 11**：错误。该数值与正确计算结果不符，请重新验算。
      - **B 12**：错误。该数值与正确计算结果不符，请重新验算。
      - **C 13**：正确答案。
      - **D 14**：错误。该数值与正确计算结果不符，请重新验算。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **B 编译**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 运行/调试**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D 发布**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 注释不参与编译**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B // 用于单行注释**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 图灵机**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 冯·诺依曼架构**：正确答案。
      - **C 哈佛架构**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D 神经元架构**：错误。与题目要求不符，请对照正确解析重新理解。

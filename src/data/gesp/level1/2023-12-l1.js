  ...
  questions: [
    // 1-15 单选题
    {
      ...
      **解析：**
      ...
      - **A CCF_GESP**：❌ 错误。该选项不满足条件，正确情况应为：变量名不能包含减号。
      - **B CCF-GESP**：✅ 正确。变量名不能包含减号。
      - **C CCFGESP**：❌ 错误。该选项不满足条件，正确情况应为：变量名不能包含减号。
      - **D ccfGesp**：❌ 错误。该选项不满足条件，正确情况应为：变量名不能包含减号。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **C 7**：❌ 错误。该选项不满足条件，正确情况应为：10-3 * 3 % 10 = 10-9 = 1。
      - **D 10**：❌ 错误。该选项不满足条件，正确情况应为：10-3 * 3 % 10 = 10-9 = 1。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A (10+N) % 12**：❌ 错误。该选项不满足条件，正确情况应为：使用取余运算计算 24 小时制时间。
      - **B (10+N) % 24**：✅ 正确。使用取余运算计算 24 小时制时间。
      - **C (10+N) / 24**：❌ 错误。该选项不满足条件，正确情况应为：整数除法会截断小数部分，请仔细验算。
      - **D 10+N**：❌ 错误。该选项不满足条件，正确情况应为：使用取余运算计算 24 小时制时间。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A N % 2 == 0**：✅ 正确。常用判断偶数方法。
      - **B N / 2 == 0**：❌ 错误。该选项不满足条件，正确情况应为：整数除法会截断小数部分，请仔细验算。
      - **C N % 2 = 0**：❌ 错误。该选项不满足条件，正确情况应为：混淆了比较 == 和赋值 =，条件判断应使用 ==。
      - **D N % 2 != 0**：❌ 错误。该选项不满足条件，正确情况应为：混淆了比较 == 和赋值 =，条件判断应使用 ==。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 3**：❌ 错误。该选项不满足条件，正确情况应为：sqrt 返回浮点数。
      - **B 3.0**：✅ 正确。sqrt 返回浮点数。
      - **C 9**：❌ 错误。该选项不满足条件，正确情况应为：sqrt 返回浮点数。
      - **D 81**：❌ 错误。该选项不满足条件，正确情况应为：sqrt 返回浮点数。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **B float a = 10;**：❌ 错误。该选项不满足条件，正确情况应为：标准定义与初始化。
      - **C char a = 10;**：❌ 错误。该选项不满足条件，正确情况应为：代码逻辑与正确答案不符。
      - **D a = 10;**：❌ 错误。该选项不满足条件，正确情况应为：标准定义与初始化。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 45**：❌ 错误。该选项不满足条件，正确情况应为：1 到 10 之和为 55。
      - **B 50**：❌ 错误。该选项不满足条件，正确情况应为：1 到 10 之和为 55。
      - **C 55**：✅ 正确。1 到 10 之和为 55。
      - **D 60**：❌ 错误。该选项不满足条件，正确情况应为：1 到 10 之和为 55。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A +**：❌ 错误。该选项不满足条件，正确情况应为：逻辑非 ! 的优先级最高。
      - **B **：❌ 错误。该选项不满足条件，正确情况应为：逻辑非 ! 的优先级最高。
      - **C &&**：❌ 错误。该选项不满足条件，正确情况应为：逻辑非 ! 的优先级最高。
      - **D !**：✅ 正确。逻辑非 ! 的优先级最高。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A cin**：❌ 错误。该选项不满足条件，正确情况应为：cout 是标准输出流。
      - **B scanf**：❌ 错误。该选项不满足条件，正确情况应为：cout 是标准输出流。
      - **C cout**：✅ 正确。cout 是标准输出流。
      - **D abs**：❌ 错误。该选项不满足条件，正确情况应为：cout 是标准输出流。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A OK**：❌ 错误。该选项不满足条件，正确情况应为：5 / 2 = 2。2 > 2 不成立，输出 KO。
      - **B KO**：✅ 正确。5 / 2 = 2。2 > 2 不成立，输出 KO。
      - **C 2.5**：❌ 错误。该选项不满足条件，正确情况应为：5 / 2 = 2。2 > 2 不成立，输出 KO。
      - **D 报错**：❌ 错误。该选项不满足条件，正确情况应为：5 / 2 = 2。2 > 2 不成立，输出 KO。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 1**：✅ 正确。char 占 1 字节。
      - **B 2**：❌ 错误。该选项不满足条件，正确情况应为：char 占 1 字节。
      - **C 4**：❌ 错误。该选项不满足条件，正确情况应为：char 占 1 字节。
      - **D 8**：❌ 错误。该选项不满足条件，正确情况应为：char 占 1 字节。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 11**：❌ 错误。该选项不满足条件，正确情况应为：1*8+1*4+0*2+1*1 = 13。
      - **B 12**：❌ 错误。该选项不满足条件，正确情况应为：可能差一错误（off-by-one），如循环条件用了 <= 而非 <。正确结果为 13。
      - **C 13**：✅ 正确。1*8+1*4+0*2+1*1 = 13。
      - **D 14**：❌ 错误。该选项不满足条件，正确情况应为：可能差一错误（off-by-one），如循环条件用了 <= 而非 <。正确结果为 13。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 编辑**：❌ 错误。该选项不满足条件，正确情况应为：编辑是修改源代码的操作，不会生成可执行代码，此选项不是正确答案。
      - **B 编译**：❌ 错误。该选项不满足条件，正确情况应为：编译是将高级语言源代码翻译成机器可执行代码的过程，此选项不是正确答案。
      - **C 运行/调试**：❌ 错误。该选项不满足条件，正确情况应为：调试是查找和修复程序错误的过程，不是生成可执行代码，此选项不是正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 注释不参与编译**：❌ 错误。该选项不满足条件，正确情况应为：编译是将高级语言源代码翻译成机器可执行代码的过程，此选项不是正确答案。
      - **B // 用于单行注释**：❌ 错误。该选项不满足条件，正确情况应为：注释可以写在程序的任何位置。
      - **C /* */ 用于多行注释**：❌ 错误。该选项不满足条件，正确情况应为：与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 图灵机**：❌ 错误。该选项不满足条件，正确情况应为：现代通用计算机大多采用冯·诺依曼架构。
      - **B 冯·诺依曼架构**：✅ 正确。现代通用计算机大多采用冯·诺依曼架构。
      - **C 哈佛架构**：❌ 错误。该选项不满足条件，正确情况应为：现代通用计算机大多采用冯·诺依曼架构。
      - **D 神经元架构**：❌ 错误。该选项不满足条件，正确情况应为：现代通用计算机大多采用冯·诺依曼架构。

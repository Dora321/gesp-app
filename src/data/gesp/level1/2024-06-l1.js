  ...
  questions: [
    {
      ...
      **解析：**
      ...
      - **A five-Star**：正确答案。
      - **B five_star**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C fiveStar**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D _fiveStar**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A -1.2**：错误。该数值与正确计算结果不符，请重新验算。
      - **B 1**：错误。该数值与正确计算结果不符，请重新验算。
      - **C 0**：错误。该数值与正确计算结果不符，请重新验算。
      - **D 2**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 1={1}**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 5%2={5%2}**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
      - **C 5%2={1}**：正确答案。
      - **D 5 ={1}**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 将输出 7**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 将输出 5**：正确答案。
      - **C 语句会报错**：错误。C++ 对某些写法可能不会报错，而是产生未定义行为或隐式转换。
      - **D 输出不确定**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 102={102}**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B a+1={a+1}**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C a + 1 = {102}**：正确答案。
      - **D 会报错**：错误。C++ 对某些写法可能不会报错，而是产生未定义行为或隐式转换。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A -17.75**：错误。该数值与正确计算结果不符，请重新验算。
      - **B -18**：正确答案。
      - **C -14**：错误。该数值与正确计算结果不符，请重新验算。
      - **D -12.75**：错误。该数值与正确计算结果不符，请重新验算。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 第5行代码1**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 第6行代码1**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 第5行代码 1**：正确答案。
      - **D 第6行代码 1**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 9 45**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 10 55**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 10 45**：正确答案。
      - **D 11 55**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 输入负数可能输出“是质数”**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 输入 2 会输出“不是质数”**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 输入 2 会输出“是质数”，即使循环体未执行**：正确答案。
      - **D 把 \`N>=2\` 改成 \`N>2\` 仍然正确**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 输入 10 时最后一行会输出 \`11 25\`**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 输入 5 时最后一行会输出 \`6 9\`**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 把 \`i += 1\` 移到 \`if\` 前面仍然正确**：正确答案。
      - **D 删去 \`if\` 并改成 \`i += 2\` 也可实现**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A i == N*N**：错误。该代码逻辑与题目要求不符，请逐步推演。
      - **B i*10 == N**：错误。该代码逻辑与题目要求不符，请逐步推演。
      - **C i+i == N**：错误。该代码逻辑与题目要求不符，请逐步推演。
      - **D i*i == N**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 感应线圈**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 电子管**：正确答案。
      - **C 晶体管**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D 集成电路**：错误。与题目要求不符，请对照正确解析重新理解。

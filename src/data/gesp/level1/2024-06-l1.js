...
export const paperData = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer: 3,
      score: 2,
      explanation: '先算乘除，`3*3=9`，整数除法 `9/5=1`，再算 `3-1=2`。',
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '`N % 3` 最大为 2，`N % 7` 最大为 6，总和最大为 8。',
      tags: [LEVEL1_TAGS.operator],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '`cin` 读取整数时遇到 `+` 会停止，因此只读到 `5`。',
    ...
    },
    {
      ...
      answer: 2,
      score: 2,
      explanation: '`(int)101.1` 得到 `101`，所以输出 `a + 1 = {102}`。',
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '`9/4=2`，`6%(6-2)=2`，所以 `2-2*10=-18`。',
      tags: [LEVEL1_TAGS.operator],
    },
    {
      id: 8,
      ...
      answer: 2,
      score: 2,
      explanation: '`10 % 3 == 1`，进入 `if` 分支，`%2d` 会保留宽度 2，因此前面有一个空格。',
    ...
    },
    {
      ...
      answer: 2,
      score: 2,
      explanation: '循环结束时 `i=10`，`sum` 为 `0+1+...+9=45`。',
    ...
    },
    {
      ...
      answer: 2,
      score: 2,
      explanation: '标准质数判定中，`N=2` 时循环可能一次也不执行，但它仍然是质数。',
    ...
    },
    {
      ...
      answer: 2,
      score: 2,
      explanation: '把 `i += 1` 提前会改变奇偶判断时机，程序逻辑会被破坏。',
    ...
    },
    {
      ...
      answer: 3,
      score: 2,
      explanation: '当存在 `i*i == N` 时，`N` 就是完全平方数。',
      tags: [LEVEL1_TAGS.operator],
    },
    {
      id: 13,
      ...
      answer: 2,
      score: 2,
      explanation: '`i` 依次为 `0,2,4,6,8`，其中满足 `i<=6` 的共有 4 个。',
    ...
    },
    {
      ...
      answer: 2,
      score: 2,
      explanation: '通常为 Scratch、Python、C++ 三种。',
      tags: [LEVEL1_TAGS.basics],
    },
    {
      id: 15,
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '如果 `X` 是浮点型，结果可能是 `1.644`，不一定是 `1`。',
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '虽然数值上前两者都为 2，但题干整体被判为错误。',
    ...
    },
    {
      ...
      answer: 1,
      score: 2,
      explanation: '它会输出字符串 `5*2`，而不是计算结果。',
      tags: [LEVEL1_TAGS.judge, LEVEL1_TAGS.io],
    },
    {
      id: 20,
    ...
    },
    {
      ...
      answer: 0,
      score: 2,
      explanation: '常见写法是先判断条件，再决定是否跳过本轮剩余语句。',
      tags: [LEVEL1_TAGS.judge, LEVEL1_TAGS.loop],
    },
    {
      id: 22,
      ...
      answer: 1,
      score: 2,
      explanation: '`printf` 是库函数名，不是语言关键字。',
      tags: [LEVEL1_TAGS.judge, LEVEL1_TAGS.basics],
    },
    {
      id: 23,
    ...
    },
    {
      ...
      answer: 0,
      score: 2,
      explanation: '同一级别主要考察相近的计算思维和程序设计能力。',
      tags: [LEVEL1_TAGS.judge, LEVEL1_TAGS.basics],
    },
    {
      id: 26,

...
export const paperData = {
  ...
  questions: [
    ...
    // 26-27 编程题
    {
      ...
      question: '# [GESP202509 一级] 超市优惠方案选择\n\n## 题目描述\n\n超市有两种优惠方案：\n1. 方案 1：满 $x$ 元减 $y$ 元（每满一个 $x$ 减一个 $y$）。\n2. 方案 2：打 $n$ 折（即原价 $\\times n / 10$）。\n\n给定 $x, y, n$ 和原价 $p$，请计算并输出最便宜的价格（保留两位小数）。\n\n## 输入格式\n\n输入一行，包含四个数值 $x, y, n, p$，相邻两个数值之间用空格隔开。\n\n## 输出格式\n\n输出一行，包含一个精确到小数点后两位的值，表示最便宜的价格。\n\n## 输入输出样例 #1\n\n### 输入 #1\n\n```\n100 20 8 250\n```\n\n### 输出 #1\n\n```\n200.00\n```\n\n## 说明/提示\n\n【样例 1 解释】\n\n按照方案 1，满 $100$ 减 $20$，$250$ 可以减 $40$，价格为 $250 - 40 = 210$。\n按照方案 2，打 $8$ 折，价格为 $250 \\times 8 / 10 = 200.00$。\n因此最便宜的价格为 200.00。',
      answer: '',
      score: 25,
    ...
    },
    {
      ...
      type: 'programming',
      template: `#include <bits/stdc++.h>\nusing namespace std;\n\nint main() {\n    // 在此填写代码\n    return 0;\n}`,
      question: '# [GESP202509 一级] 石块累加\n\n## 题目描述\n\n小杨在搭石块，第 $1$ 层需要 $1 \\times 1$ 个石块，第 $2$ 层需要 $2 \\times 2$ 个石块…… 第 $i$ 层需要 $i \\times i$ 个石块。\n\n给定总层数 $n$，求共需要多少个石块。\n\n## 输入格式\n\n输入一行，包含一个整数 $n$，表示总层数。\n\n## 输出格式\n\n输出一行，包含一个整数，表示共需要的石块数量。\n\n## 输入输出样例 #1\n\n### 输入 #1\n\n```\n3\n```\n\n### 输出 #1\n\n```\n14\n```\n\n## 说明/提示\n\n【样例 1 解释】\n\n第 $1$ 层需要 $1$ 个石块，第 $2$ 层需要 $4$ 个石块，第 $3$ 层需要 $9$ 个石块，总共需要 $1 + 4 + 9 = 14$ 个石块。',
      answer: '',
      score: 25,

  ...
  questions: [
    // 1-15 单选题
    {
      ...
      **解析：**
      ...
      - **C 显示器**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D 音箱**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 编写程序**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B 翻译语言**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C 炒菜**：正确答案。
      - **D 写诗**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A int**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B double**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C char**：正确答案。
      - **D bool**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **B 变量必须先赋值再定义**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **B 2023_GESP**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C GESP-2023**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D cout**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A int**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B for**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C if**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D endl**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A a = b+c;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B b = a;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C c = a / b;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D a+c = b+c;**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **B pow(a, 2)**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C a ^ 2**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 22**：错误。该数值与正确计算结果不符，请重新验算。
      - **B 22.75**：错误。该数值与正确计算结果不符，请重新验算。
      - **C 23**：正确答案。
      - **D 25**：错误。该数值与正确计算结果不符，请重新验算。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A a == 0 || b == 0**：错误。该代码逻辑与题目要求不符，请逐步推演。
      - **B !(a || b)**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C a+b == 0**：错误。该代码逻辑与题目要求不符，请逐步推演。
      - **D a == 0 && b == 0**：正确答案。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A 0.0+a / b**：正确答案。
      - **B (double)a / b**：错误。与题目要求不符，请对照正确解析重新理解。
      - **C a / (double)b**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A b = a;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **B b = 10;**：正确答案。
      - **C b = a-b;**：错误。与题目要求不符，请对照正确解析重新理解。
      - **D b = 20;**：错误。与题目要求不符，请对照正确解析重新理解。
    ...
    },
    {
      ...
      **解析：**
      ...
      - **A i % 2 == 1**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
      - **B i % 3 == 1**：正确答案。
      - **C i % 4 == 1**：错误。取模运算的结果需要仔细计算，注意运算符优先级。
      - **D i % 7 == 1**：错误。取模运算的结果需要仔细计算，注意运算符优先级。

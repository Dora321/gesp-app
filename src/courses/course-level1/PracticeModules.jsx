...
import { Code, AlertTriangle, Play, ChevronRight, CheckCircle, Info, Copy, Check, Zap, Trophy, RefreshCw, XCircle, Unlock, Lightbulb, Target, Clock, Award, FileCode, ArrowRightLeft, Eye } from 'lucide-react';

export const CodeTraceSection = () => {
...
export const CaseCard = ({ year, title, desc }) => (

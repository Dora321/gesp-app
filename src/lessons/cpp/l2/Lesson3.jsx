...
export default function CppL2Lesson3() {
    return (
        <CppLessonShell
            lessonNumber={3}
            lessonTitle="数据变形记 (类型转换)"
            lessonSubtitle="int、double、char 的转换规则"
            accent="blue"
            sections={sections}
            previousPath="/lesson/2/2"
            nextPath="/lesson/2/4"
            topSupport={<CppL2LessonSupport lessonId={3} />}
            bottomSupport={<CppL2LessonSupport lessonId={3} placement="bottom" />}
            hero={{

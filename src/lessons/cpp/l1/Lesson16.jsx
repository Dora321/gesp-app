...
const sections = [
    ...
    { id: 2, title: "导入：发射前安检", icon: "shield", category: "考点总复习" },
    { id: 3, title: "安检1：变量饭盒", icon: "book", category: "考点总复习" },
    { id: 4, title: "安检2：运算交警", icon: "zap", category: "考点总复习" },
    { id: 5, title: "安检3：循环跑道", icon: "timer", category: "考点总复习" },
    { id: 6, title: "任务1：逻辑陷阱", icon: "calc", category: "真题实战" },
                ...
                return (
                    <div className="slide-enter h-full flex flex-col justify-center items-center text-center">
                        <div className="bg-slate-800/50 p-10 rounded-3xl border border-cyan-500/30 backdrop-blur-sm max-w-2xl">
                            ...
                            <button onClick={() => navigate('/')} className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-8 py-3 rounded-full font-bold text-xl shadow-lg hover:scale-110 transition-transform flex items-center gap-2 mx-auto">
                ...
                <div className="p-6 border-b border-slate-100 bg-gradient-to-br from-blue-50/50 to-white/50 backdrop-blur-sm">
                    <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity group">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-blue-500 font-medium">第 16 课：考前冲刺</p>
                        </div>
                    </Link>
                </div>
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden w-full relative pt-16 md:pt-0">
                ...
                <main className="flex-1 overflow-y-auto p-8 z-0">
                    <div className="max-w-4xl mx-auto pb-12">
                        {activeSection === 1 && <CppL1LessonSupport lessonId={16} />}
                        {renderContent()}
                        {activeSection === sections.length && <CppL1LessonSupport lessonId={16} placement="bottom" />}
                    </div>
                </main>
              ...
              ${activeSection === sections.length ? 'bg-green-600 text-white hover:bg-green-700 shadow-sm' : 'bg-blue-600 text-white hover:bg-blue-700 hover:shadow-md hover:-translate-y-0.5'}`}
                    >
                        {activeSection === sections.length ? '完成课程' : '下一步'} <ArrowRight size={18} color="white" />
                    </button>
                </footer>
            </div>
        </div>

...
// --- 章节数据 ---
const sections = [
    { id: 1, title: "课程导入：逻辑便利店", icon: "store" },
    { id: 2, title: "必杀技：模拟三部曲", icon: "book" },
    { id: 3, title: "模拟实验室：机器人大冒险", icon: "bot" },
    { id: 4, title: "避坑指南：模拟题雷区", icon: "alert" },
    { id: 5, title: "真题实战 1：买文具", icon: "bag" },
    { id: 6, title: "真题实战 2：小杨的考试", icon: "calendar" },
    { id: 7, title: "总结与作业", icon: "check" }
];
            ...
            <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full shadow-lg z-20">
                <div className="p-5 border-b border-gray-100 sticky top-0 bg-white z-10">
                    <h1 className="font-bold text-xl text-green-600 flex items-center gap-2">
                        <Icon name="calc" size={24} />
                        GESP C++ 一级
                    </h1>
                    <p className="text-xs text-gray-500 mt-2 bg-green-50 inline-block px-2 py-1 rounded">第14课：模拟与逻辑</p>
                </div>
                ...
                ${activeSection === section.id
                                    ? 'bg-green-100 text-green-800 font-bold shadow-sm ring-1 ring-green-200'

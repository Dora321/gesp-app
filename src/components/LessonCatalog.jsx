    ...
    const lessonSections = [
        {
            ...
            color: 'emerald',
            lessons: [
                { id: 1, title: '第 1 关：启程', path: '/lesson1' },
                { id: 2, title: '第 2 关：变量与运算', path: '/lesson2' },
                { id: 3, title: '第 3 关：条件判断', path: '/lesson3' },
                { id: 4, title: '第 4 关：循环初探', path: '/lesson4' },
                { id: 5, title: '第 5 关：数组入门', path: '/lesson5' },
                { id: 6, title: '第 6 关：函数基础', path: '/lesson6' },
                { id: 7, title: '第 7 关：字符串处理', path: '/lesson7' },
                { id: 8, title: '第 8 关：指针初探', path: '/lesson8' },
                { id: 9, title: '第 9 关：综合练习', path: '/lesson9' },
                { id: 10, title: '第 10 关：排序算法', path: '/lesson10' },
                { id: 11, title: '第 11 关：搜索算法', path: '/lesson11' },
                { id: 12, title: '第 12 关：结构体', path: '/lesson12' },
                { id: 13, title: '第 13 关：文件操作', path: '/lesson13' },
                { id: 14, title: '第 14 关：递归入门', path: '/lesson14' },
                { id: 15, title: '第 15 关：STL 基础', path: '/lesson15' },
                { id: 16, title: '第 16 关：期末测验', path: '/lesson16' },
            ]
        },
        {
            id: 'advanced',
            ...
            color: 'purple',
            lessons: [
                { id: 1, title: '第 1 关：计算机内存与网络', path: '/adv-lesson1' },
                { id: 2, title: '第 2 关：双层循环', path: '/adv-lesson2' },
                { id: 3, title: '第 3 关：位运算', path: '/adv-lesson3' },
                { id: 4, title: '第 4 关：时间复杂度', path: '/adv-lesson4' },
                { id: 5, title: '第 5 关：贪心算法', path: '/adv-lesson5' },
                { id: 6, title: '第 6 关：二分查找', path: '/adv-lesson6' },
                { id: 7, title: '第 7 关：栈与队列', path: '/adv-lesson7' },
                { id: 8, title: '第 8 关：动态规划入门', path: '/adv-lesson8' },
                { id: 9, title: '第 9 关：递归进阶', path: '/adv-lesson9' },
                { id: 10, title: '第 10 关：图论基础', path: '/adv-lesson10' },
                { id: 11, title: '第 11 关：DFS 深度搜索', path: '/adv-lesson11' },
                { id: 12, title: '第 12 关：BFS 广度搜索', path: '/adv-lesson12' },
                { id: 13, title: '第 13 关：树结构', path: '/adv-lesson13' },
                { id: 14, title: '第 14 关：字符串算法', path: '/adv-lesson14' },
                { id: 15, title: '第 15 关：数学进阶', path: '/adv-lesson15' },
                { id: 16, title: '第 16 关：综合考核', path: '/adv-lesson16' },
            ]
        },
        {
            id: 'python-basic',

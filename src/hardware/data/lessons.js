...
export const hardwareLessons = [
    ...
    },
    {
        ...
        icon: MousePointer2,
        mode: "realtime",
        components: ["按钮 (HS-KEY1B)"],
        objectives: "掌握按键开关 (HS-KEY1B) 的数字输入特性与条件判断。",
        story: "电光城的灯修好了，但不能总亮着呀。我们需要一个 ‘开关指挥官’！按下按钮，熊猫（屏幕角色）就变身；松开按钮，它就变回来。",
        knowledge: "数字输入。按钮连接 D2。按下=1 (高电平)，松开=0 (低电平)。Mind+ 中使用 “如果...那么...否则” 积木。",
        wiring: "按钮 → D2",
    ...
    },
    {
        ...
        icon: Zap,
        mode: "upload",
        components: ["光敏 (HS-S20A)", "按钮 (HS-KEY1B)"],
    ...
    },
    {
        ...
        icon: Bell,
        mode: "upload",
        components: ["光敏 (HS-S20A)", "蜂鸣器 (HS-F07A)", "按钮 (HS-KEY1B)"],
